...
enet_peer_send (ENetPeer * peer, enet_uint8 channelID, ENetPacket * packet)
{
   ...
   int protoHeaderSize = peer->host->usingNewPacket == 1 ? sizeof(ENetProtocolHeader2) : sizeof(ENetProtocolHeader);
   fragmentLength = peer -> mtu - protoHeaderSize - sizeof (ENetProtocolSendFragment);
